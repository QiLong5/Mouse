...
public class Item : MonoBehaviour
{
    ...
    public void MoveAlongCurve(Vector3 _startPosition, Vector3 _endPosition, Action action=null,Vector3 offsetRotation=default)
    {
        StopAllCoroutines();
        StartCoroutine(MoveAlongCurve_Coroutine(_startPosition, _endPosition, action,offsetRotation));
    }
    private IEnumerator MoveAlongCurve_Coroutine(Vector3 _startPosition, Vector3 _endPosition, Action action=null,Vector3 offsetRotate=default)
    {
